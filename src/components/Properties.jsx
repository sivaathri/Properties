    ...
    <div className="w-full bg-white min-h-screen">
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white border-t border-stone-100">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Statistics Bar (Placed below the Section Header) */}
          <div className="w-full bg-[#D29F13] rounded-2xl md:rounded-[1.5rem] py-6 px-6 md:px-10 relative overflow-hidden mb-16 shadow-lg z-20 animate-fade-in">
      ...
      <section className="w-full pt-4 pb-16 px-4 sm:px-6 lg:px-8 bg-white">        <div className="max-w-7xl mx-auto">
